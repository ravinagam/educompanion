...
const steps = [
  {
    ...
    href: '/upload',
    cta: 'Go to Upload',
    body: 'Start by uploading any chapter you want to study. Drop in a PDF, Word doc, or plain text file. Got a physical textbook? Switch to "Upload Screenshots" and snap photos of the pages — AI reads the text for you.',
  ...
  },
  {
    ...
    href: '/chapters',
    cta: 'My Chapters',
    body: 'Once your chapter is ready, EaseStudy breaks it into bite-sized sections automatically. Work through each section at your own pace and mark them done as you go.',
  ...
  },
  {
    ...
    href: '/chapters',
    cta: 'My Chapters',
    body: 'Stuck on something? Open the "Ask AI" chat on any chapter or section. Ask it to explain a concept, give an example, simplify something, or predict what might come in your exam.',
            ...
            <div key={step.number} className={`rounded-2xl border ${c.border} ${c.bg} p-5${step.number === 5 ? ' md:col-span-2' : ''}`}>
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <Link href={step.href} className={`inline-flex items-center gap-1 text-xs font-semibold ${c.text} hover:underline`}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5 items-start">
        <div className="rounded-2xl border border-amber-200 bg-amber-50 p-5">
          ...
          <ul className="space-y-2">
            {[
              'Upload one chapter at a time — smaller files process faster.',
              'Use "Upload Screenshots" if your PDF is a scanned image.',
        ...
        <div className="rounded-2xl border border-blue-200 bg-gradient-to-br from-blue-50 to-indigo-50 p-5 flex gap-4 items-start">
          ...
          <div>
            ...
            <p className="text-sm text-blue-700 leading-relaxed">
              Open the Upload page, switch to <span className="font-semibold">Upload Screenshots</span>, and take photos of each page in order. EaseStudy reads the text from your images and creates all the same study tools.
            </p>
          </div>
        </div>
      </div>
